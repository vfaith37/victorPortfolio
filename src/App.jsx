...
function App() {
		const currentYear = new Date().getFullYear();/* eslint-disable react/no-unescaped-entities */
/* eslint-disable no-unused-vars */
import { useEffect, useState } from 'react'
import {FaCar, FaCss3Alt, FaDharmachakra, FaDocker, FaGithub, FaHtml5, FaInstagram, FaJava, FaJsSquare, FaLinkedin, FaLinkedinIn, FaMoon, FaPhp, FaPython, FaSun, FaTwitter } from "react-icons/fa"
import { HiMenu, HiOutlineX } from "react-icons/hi"
        ...
        <a href="#" className="gap-6 justify-between flex text-center text-sm sm:text-base font-normal font-outfit text-black dark:text-white">Contact me</a>
				...
				<div className='flex gap-3 justify-center items-center '>
					...
					>
						...
						<section className='sm:mt-32 mt-16 text-red-950 dark:text-white flex flex-col items-center'>
...
{/* <div className='flex justify-between'> */}
	<img src={EXTRA} alt="extra" className='absolute bottom-96 left-[2rem] sm:bottom-32 sm:left-[20rem]' /><img src={ARROW} alt="arrow" className='self-center' />
{/* </div> */}
		</section>
